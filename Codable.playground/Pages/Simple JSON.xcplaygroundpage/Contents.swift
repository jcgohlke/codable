/*:
 ...
 With Swift 4, marshaling data into and out of JSON format is much simpler. Let's imagine a model to categorize a list of movies that are coming out this summer. The `struct` below is a simple model that provides properties for a movie's title, genre, and rating.
...
struct Movie: Codable, Equatable {
    ...
    static func ==(lhs: Movie, rhs: Movie) -> Bool {
        return lhs.title == rhs.title && lhs.genre == rhs.genre
    }
}
